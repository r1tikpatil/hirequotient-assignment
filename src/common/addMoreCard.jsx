...
const AddMoreCard = ({ keys, heading, title }) => {
  return (
    <div className="w-full border mt-8 bg-[#212121] px-8 md:px-16 h-[40vh] rounded-3xl flex flex-col justify-center items-center">
      ...
      <p className="text-white mt-6 text-xl text-center md:text-2xl font-bold">{heading}</p>
